...
// @ts-ignore
import { AnimalJsonld } from '../model/animal-jsonld';
// @ts-ignore
...
export class AnimalService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAnimalCollection(page?: number, name?: string, orderName?: 'asc' | 'desc', orderId?: 'asc' | 'desc', observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/ld+json' | 'application/json' | 'text/html',}): Observable<InlineResponse200>;
    public getAnimalCollection(page?: number, name?: string, orderName?: 'asc' | 'desc', orderId?: 'asc' | 'desc', observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/ld+json' | 'application/json' | 'text/html',}): Observable<HttpResponse<InlineResponse200>>;
    public getAnimalCollection(page?: number, name?: string, orderName?: 'asc' | 'desc', orderId?: 'asc' | 'desc', observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/ld+json' | 'application/json' | 'text/html',}): Observable<HttpEvent<InlineResponse200>>;
    public getAnimalCollection(page?: number, name?: string, orderName?: 'asc' | 'desc', orderId?: 'asc' | 'desc', observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/ld+json' | 'application/json' | 'text/html',}): Observable<any> {
