...
// @ts-ignore
import { OwnerFullOwner } from '../model/owner-full-owner';
// @ts-ignore
import { OwnerJsonldFullOwner } from '../model/owner-jsonld-full-owner';
// @ts-ignore
import { OwnerJsonldLiteOwner } from '../model/owner-jsonld-lite-owner';
// @ts-ignore
import { OwnerLiteOwner } from '../model/owner-lite-owner';
...
export class OwnerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getOwnerCollection(page?: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/ld+json' | 'application/json' | 'text/html',}): Observable<InlineResponse2001>;
    public getOwnerCollection(page?: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/ld+json' | 'application/json' | 'text/html',}): Observable<HttpResponse<InlineResponse2001>>;
    public getOwnerCollection(page?: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/ld+json' | 'application/json' | 'text/html',}): Observable<HttpEvent<InlineResponse2001>>;
    public getOwnerCollection(page?: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/ld+json' | 'application/json' | 'text/html',}): Observable<any> {
        ...
        return this.httpClient.get<InlineResponse2001>(`${this.configuration.basePath}/api/owners`,
            {
